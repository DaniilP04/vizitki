<template>
    <div class="flex flex-col md:flex-row items-center justify-center min-h-screen p-6">
      ...
      <div class="md:w-1/3 flex justify-center">
        <img src="/img/danil.jpg" alt="Daniil" class="scale-110 mt-20 mb-4 rounded-lg shadow-lg max-w-xs md:max-w-sm object-cover w-full" />
      </div>
      <div class="md:w-2/3 md:pl-10 text-center md:text-left">
        ...
        <a href="https://wa.me/qr/N34VOCIVPCT6L1" target="_blank" class="hover:underline text-lg font-semibold">
          Связаться со мной
        </a>
        </button>
      </div>
